...
describe("RichStringProcessor", () => {
    ...
    test.each([
        ...
        const proc = new RichStringProcessor(hassMock.hass, undefined);
    ...
    test.each([
        ...
        const proc = new RichStringProcessor(hassMock.hass, hassMock.createAccessor(motionEntity.entity_id));
    ...
    test("using computed data", () => {
        ...
        const proc = new RichStringProcessor(hassMock.hass, accessor);
